...
@Component
public class Rcv1ArticleNgramIndicesStreamer extends Rcv1ArticleStreamer {

    public Rcv1ArticleNgramIndicesStreamer(
    ...
    public String getIndicesFrom(JsonObject articleJson) {
        return getNgramIndices(articleJson, "tokens");
    }
}
